...
function addquestion()
{
	...
	questionPhoto = document.form.questionPhoto.value
	...
	invalidLink = false
	if (!questionPhoto.includes("http://") && !questionPhoto.includes("https://")) //On vérifie que le lien est valide
	{
		console.log("Le lien est invalide")
		document.getElementById('warning').textContent = "Le lien de la photo de la question est invalide"
		document.getElementById('warning').color = "red"
		invalidLink = true
	}
	
	if (alreadyExists == false && emptyField == false && invalidLink == false) // Si il n'y a pas de problème, on enregistre
	{
